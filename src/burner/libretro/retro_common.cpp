...
static const struct retro_core_option_definition var_fbneo_diagnostic_input = {
	...
	"设置进入基板服务菜单的组合键",
	{
		...
		{ "Hold Start", "按住 Start" },
		{ "Start + A + B", NULL },
		{ "Hold Start + A + B", "按住 Start + A + B" },
		{ "Start + L + R", "按住 + L + R" },
		{ "Hold Start + L + R", "按住 Start + L + R" },
		{ "Hold Select", "按住 Select" },
		{ "Select + A + B", NULL },
		{ "Hold Select + A + B", "按住 Select + A + B" },
		{ "Select + L + R", NULL },
		{ "Hold Select + L + R", "按住 Select + L + R" },
		{ NULL, NULL },
	},
	"Hold Start"
};
